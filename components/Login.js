    ...
    return (
        <>
            ...
            <View style={{ marginTop: 70 }}>
                <Text style={styles.profileTxt}>Login</Text>
            </View>
            ...
            <TouchableOpacity>
                <Text style={{ alignSelf: 'flex-end', marginRight: 20, marginTop: 10, color: colors.textLight }}>Forget Password ?</Text>
            </TouchableOpacity>
            ...
            <View style={{ marginTop: '23%' }}>
                ...
                <View style={{ flexDirection: 'row', alignSelf: 'center', margin: 1, }}>
